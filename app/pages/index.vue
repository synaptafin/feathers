...
<template>
  <div class="w-full grid grid-cols-[repeat(auto-fit,minmax(150px,1fr))] gap-12 py-12 px-24">
    <IndexCard v-for="item in items" :key="item.text" :icon-name="item.icon" :text="item.text" :to="item.link" />
  </div>
</template>
